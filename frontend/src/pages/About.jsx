    ...
    >
      ...
      <div className=" w-[90vw] md:w-[50vw] flex flex-col gap-8 m-5 md:m-10">
        ...
        <p className="text-2xl leading-8">
          ...
          insightful perspectives on parenting find a home. Our platform is more
          than just a blog; it's a tranquil oasis where the quiet power of
          shared experiences fosters connection, understanding, and growth.
        </p>
        <p className="text-2xl leading-8">
          ...
          provides a space for parents to pause, reflect, and share their wisdom
          with the world. Whether you're a seasoned parent or embarking on the
          adventure of parenthood for the first time, Tarbiatales welcomes you
        ...
        <p className="text-2xl leading-8">
          ...
          experiences that enriches our collective understanding of parenthood.
        </p>
        <p className="text-2xl leading-8">
          Join us in celebrating the diversity of parenting journeys and the
          profound impact of authentic storytelling. Whether you're here to seek
          guidance, share your own experiences, or simply find solace in the
          stories of others, Tarbiatales invites you to be part of our nurturing
          community.
        </p>
        <p className="text-2xl leading-8">
          Together, let's elevate the conversation around parenting, deepen our
          connections, and pave the way for a brighter, more informed future for
          families everywhere.
        </p>
        <p className="text-2xl leading-8">
