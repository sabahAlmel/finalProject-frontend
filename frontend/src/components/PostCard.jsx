...
export default function PostCard({ post }) {
  return (
    <div className="group relative w-[80%] mx-4 border border-customMediumBlue hover:border-2 h-[350px] overflow-hidden rounded-lg sm:w-[350px] transition-all mb-6">
